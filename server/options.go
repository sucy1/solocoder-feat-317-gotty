...
type Options struct {
	...
	Record              bool             `hcl:"record" flagName:"record" flagDescribe:"Record terminal session to a JSON file" default:"false"`
	Play                string           `hcl:"play" flagName:"play" flagDescribe:"Play back a recorded session from a JSON file" default:""`
	RecordFile          string           `hcl:"record_file" flagName:"record-file" flagDescribe:"File path to save the recording (default: ~/.gotty/records/{timestamp}.json)" default:""`
